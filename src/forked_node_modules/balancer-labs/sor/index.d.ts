...
type WeightedPoolToken = Pick<NoNullableField<SubgraphToken>, 'address' | 'balance' | 'decimals' | 'weight'>;
type WeightedPoolPairData = PoolPairBase & {
...
type StablePoolPairData = PoolPairBase & {
...
type MetaStablePoolPairData = StablePoolPairData & {
...
type PhantomStablePoolPairData = MetaStablePoolPairData & {
...
type LinearPoolPairData = PoolPairBase & {
    pairType: PairTypes;
