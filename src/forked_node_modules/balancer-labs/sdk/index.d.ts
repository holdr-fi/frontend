...
import { TokenPriceService, PoolDataService, SwapInfo, SOR, SubgraphPoolBase, SwapTypes, SwapV2 } from '../sor';
...
declare class Pools implements Findable<PoolWithMethods> {
     ...
     */
    generalisedJoin(poolId: string, tokens: string[], amounts: string[], userAddress: string, wrapMainTokens: boolean, slippage: string, signer: JsonRpcSigner, authorisation?: string): Promise<{
        to: string;
        callData: string;
        minOut: string;
        expectedOut: string;
     ...
     */
    generalisedExit(poolId: string, amount: string, userAddress: string, slippage: string, signer: JsonRpcSigner, authorisation?: string): Promise<{
        to: string;
        callData: string;
        tokensOut: string[];
        expectedAmountsOut: string[];
