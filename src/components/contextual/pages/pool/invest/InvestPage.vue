...
import InvestFormDeep from '@/components/forms/pool_actions/InvestForm/InvestFormDeep.vue';
...
const { isStablePhantomPool, isDeepPool, isPreMintedBptPool } = usePool(pool);
