...
class Join {
    ...
    async staticMulticall(signer, encodedMulticalls) {
        ...
        return abi$1.defaultAbiCoder.decode(['bytes[]'], staticResult)[0];
    }
...
class Exit {
    ...
    async exitPool(poolId, amountBptIn, userAddress, slippage, authorisation) {
        /*
        ...
        */
        ...
        const { expectedAmountsOutByExitPath, minAmountsOutByExitPath } = await this.amountsOutByExitPath(userAddress, staticCall.callData, orderedNodes[0].address, staticCall.outputIndexes, slippage);
        // Create calls with minimum expected amount out for each exit path
...
class Pools {
     ...
     */
    async generalisedExit(poolId, amount, userAddress, slippage, authorisation) {
        return this.exitService.exitPool(poolId, amount, userAddress, slippage, authorisation);
    }
    /**
