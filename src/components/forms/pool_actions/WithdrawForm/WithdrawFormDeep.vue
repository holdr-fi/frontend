...
import ProportionalWithdrawalInputDeep from './components/ProportionalWithdrawalInputDeep.vue';
import WithdrawTotalsDeep from './components/WithdrawTotalsDeep.vue';
import useExitPool from '@/composables/pools/useExitPool';
import useVeBal from '@/composables/useVeBAL';
import WithdrawPreviewModalDeep from './components/WithdrawPreviewModal/WithdrawPreviewModalDeep.vue';
...
<template>
  <div>
    <ProportionalWithdrawalInputDeep v-if="!isSingleAssetExit" :pool="pool" />
    <template v-else>
