...
declare type SdkFunctionWrapper = <T>(
...
declare function getSdk(
  ...
  PoolsWithoutLinear(
    variables?:
      ...
      | undefined,
    requestHeaders?: Dom.RequestInit['headers']
  ): Promise<PoolsWithoutLinearQuery>;
  PoolWithoutLinear(
    variables: PoolWithoutLinearQueryVariables,
    requestHeaders?: Dom.RequestInit['headers']
  ): Promise<PoolWithoutLinearQuery>;
...
declare class Stable implements PoolType$1 {
  ...
  spotPriceCalculator: SpotPriceConcern;
  constructor(
    liquidityCalculatorConcern?: typeof StablePoolLiquidity,
    spotPriceCalculatorConcern?: typeof StablePoolSpotPrice
  );
}
...
declare class Weighted implements PoolType$1 {
  ...
  spotPriceCalculator: SpotPriceConcern;
  constructor(
    liquidityCalculatorConcern?: typeof WeightedPoolLiquidity,
    spotPriceCalculatorConcern?: typeof WeightedPoolSpotPrice
  );
}
...
declare class MetaStable implements PoolType$1 {
  ...
  spotPriceCalculator: SpotPriceConcern;
  constructor(
    liquidityCalculatorConcern?: typeof MetaStablePoolLiquidity,
    spotPriceCalculatorConcern?: typeof MetaStablePoolSpotPrice
  );
}
...
declare class StablePhantom implements PoolType$1 {
  ...
  spotPriceCalculator: SpotPriceConcern;
  constructor(
    liquidityCalculatorConcern?: typeof StablePhantomPoolLiquidity,
    spotPriceCalculatorConcern?: typeof StablePhantomPoolSpotPrice
  );
}

declare class ComposableStable implements PoolType$1 {
  private liquidityCalculatorConcern;
  private spotPriceCalculatorConcern;
  liquidityCalculator: LiquidityConcern;
  spotPriceCalculator: SpotPriceConcern;
...
declare class Linear implements PoolType$1 {
  ...
  spotPriceCalculator: SpotPriceConcern;
  constructor(
    liquidityCalculatorConcern?: typeof LinearPoolLiquidity,
    spotPriceCalculatorConcern?: typeof LinearPoolSpotPrice
  );
}
...
declare class Pools {
  ...
  static from(
    pool: SubgraphPoolBase
  ): Weighted | Stable | MetaStable | StablePhantom | Linear | ComposableStable;
}
